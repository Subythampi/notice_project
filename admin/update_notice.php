...
if(isset($update))
{
mysql_query("update notice set subject='$sub',Description='$details' where notice_id='".$_GET['notice_id']."'");
...
$q=mysql_query("select * from notice where notice_id='".$_GET['notice_id']."'");
